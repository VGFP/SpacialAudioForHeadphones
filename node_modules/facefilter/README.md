...
**THIS NPM PACKAGE IS LIKELY NOT THE LAST FACEFILTER VERSION
PLEASE VISIT THE GITHUB OF FACEFILTER TO GET THE LATEST VERSION: [github.com/jeeliz/jeelizFaceFilter](https://github.com/jeeliz/jeelizFaceFilter)
(THERE IS AN ES6 VERSION - MORE DETAILS HERE: [#24](https://github.com/jeeliz/jeelizFaceFilter/issues/24))**

**DEMOS AND THIRD PARTY LIBRARIES ARE NOT INCLUDED IN THE NPM PACKAGE ANYMORE
(BUT THEY ARE STILL IN THE GITHUB REPOSITORY IN `/demos` AND `/libs`)**
